...
private:
	 ...
	 */
	void load_archived(const std::string& filename);
	/**
	 ...
	 */
	void do_Fano_Algorithm(std::optional<std::span<std::pair<uint8_t, size_t>>> vec = std::nullopt, uint32_t vec_sum = 0);
	/**
